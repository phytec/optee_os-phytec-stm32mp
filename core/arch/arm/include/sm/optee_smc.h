 ...
 */
#define OPTEE_SMC_FUNCID_CALL_WITH_ARG_NSEC_NOIRQ	U(56)
 ...
 */
#define OPTEE_SMC_FUNCID_CALL_WITH_RPC_ARG_NSEC_NOIRQ	U(57)
 ...
 */
#define OPTEE_SMC_FUNCID_CALL_WITH_REGD_ARG_NSEC_NOIRQ	U(58)
