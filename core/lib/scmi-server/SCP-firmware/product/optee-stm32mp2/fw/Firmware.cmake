...
if(CFG_SCPFW_MOD_STM32_OPP)
list(PREPEND SCP_MODULE_PATHS "${CMAKE_CURRENT_LIST_DIR}/../module/stm32_opp")
endif(CFG_SCPFW_MOD_STM32_OPP)
...
if(CFG_SCPFW_MOD_STM32_OPP)
list(APPEND SCP_MODULES "stm32-opp")
endif(CFG_SCPFW_MOD_STM32_OPP)
